            ...
            <div data-class="search_wrapper" @class([$this->getClass('search_wrapper')])>
                ...
                @if ($dateFilterEnabled && $dateFilterColumn)
                    <div data-class="date_filter_badge" @class([$this->getClass('date_filter_badge')])>
                        <span>{{ $this->dateFilterableColumns[$dateFilterColumn] ?? $dateFilterColumn }}: {{ $dateFilterStart ?: '...' }} &mdash; {{ $dateFilterEnd ?: '...' }}</span>
                        <button type="button" wire:click="resetDateFilter" data-class="date_filter_badge_remove" @class([$this->getClass('date_filter_badge_remove')])>&times;</button>
                    </div>
                @endif

                @if ($showDateFilter)
                    <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 dark:bg-gray-900/70"
                        ...
                        <div data-class="date_filter_modal" @class([$this->getClass('date_filter_modal')])>
                            <div data-class="date_filter_header" @class([$this->getClass('date_filter_header')])>
                                <h3 data-class="date_filter_title" @class([$this->getClass('date_filter_title')])>Date Filter</h3>
                                <button type="button" wire:click="closeDateFilterPanel" data-class="date_filter_close" @class([$this->getClass('date_filter_close')])>
                            ...
                            <div data-class="date_filter_body" @class([$this->getClass('date_filter_body')])>
                                <div>
                                    <label data-class="date_filter_column_label" @class([$this->getClass('date_filter_column_label')])>Column</label>
                                    <select wire:model.live="dateFilterColumn" data-class="date_filter_column_select" @class([$this->getClass('date_filter_column_select')])>
                                ...
                                @if ($dateFilterColumn)
                                    <div data-class="date_filter_date_row" @class([$this->getClass('date_filter_date_row')])>
                                        <div data-class="date_filter_date_group" @class([$this->getClass('date_filter_date_group')])>
                                            <label data-class="date_filter_column_label" @class([$this->getClass('date_filter_column_label')])>Start</label>
                                            <input type="date" wire:model.live.debounce.300ms="dateFilterStart" data-class="date_filter_date_input" @class([$this->getClass('date_filter_date_input')])>
                                        </div>
                                        <span data-class="date_filter_date_separator" @class([$this->getClass('date_filter_date_separator')])>to</span>
                                        <div data-class="date_filter_date_group" @class([$this->getClass('date_filter_date_group')])>
                                            <label data-class="date_filter_column_label" @class([$this->getClass('date_filter_column_label')])>End</label>
                                            <input type="date" wire:model.live.debounce.300ms="dateFilterEnd" data-class="date_filter_date_input" @class([$this->getClass('date_filter_date_input')])>
                                            @error('dateFilterEnd')
                            ...
                            <div data-class="date_filter_footer" @class([$this->getClass('date_filter_footer')])>
                                <button type="button" wire:click="resetDateFilter" data-class="date_filter_reset" @class([$this->getClass('date_filter_reset')])>Reset</button>
                                <button type="button" wire:click="applyDateFilter" data-class="date_filter_apply" @class([$this->getClass('date_filter_apply')])>Apply</button>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div data-class="custom_export_modal" @class([$this->getClass('custom_export_modal')])>
                ...
                <div data-class="custom_export_footer" @class([$this->getClass('custom_export_footer')])>
                    <div data-class="custom_export_type_wrapper" @class([$this->getClass('custom_export_type_wrapper')])>
                        ...
                        <select wire:model.live="customExportType" data-class="custom_export_type_select"
                            @class([$this->getClass('custom_export_type_select')])>
                        ...
                        @if ($customExportType === 'pdf')
                            ...
                            <select wire:model="customExportPaperSize" data-class="custom_export_type_select"
                                @class([$this->getClass('custom_export_type_select')])>
                            ...
                            <select wire:model="customExportOrientation" data-class="custom_export_type_select"
                                @class([$this->getClass('custom_export_type_select')])>
                    ...
                    <div data-class="custom_export_actions" @class([$this->getClass('custom_export_actions')])>
                        <button type="button" wire:click="closeCustomExport"
                            data-class="custom_export_cancel" @class([$this->getClass('custom_export_cancel')])>Cancel</button>
                        <button type="button" wire:click="customExport"
