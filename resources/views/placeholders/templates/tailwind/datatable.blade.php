<div>
    <div @class([
        ...
        <div @class([config('livewire-datatable.theme')['main_wrapper']])>
                                ...
                                <div @class([config('livewire-datatable.theme')['empty_content']])>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                        ...
                                        <circle cx="12" cy="2" r="0" fill="currentColor"
                                            ...
                                            <animate attributeName="r" begin="0.625s" calcMode="spline"
                                                dur="1s"
                                                keySplines="0.2 0.2 0.4 0.8;0.2 0.2 0.4 0.8;0.2 0.2 0.4 0.8"
                                                repeatCount="indefinite" values="0;2;0;0" />
                                        </circle>
                                        <circle cx="12" cy="2" r="0" fill="currentColor"
                                            ...
                                            <animate attributeName="r" begin="0.75s" calcMode="spline"
                                                dur="1s"
                                                keySplines="0.2 0.2 0.4 0.8;0.2 0.2 0.4 0.8;0.2 0.2 0.4 0.8"
                                                repeatCount="indefinite" values="0;2;0;0" />
                                        </circle>
                                        <circle cx="12" cy="2" r="0" fill="currentColor"
                                            ...
                                            <animate attributeName="r" begin="0.875s" calcMode="spline"
                                                dur="1s"
                                                keySplines="0.2 0.2 0.4 0.8;0.2 0.2 0.4 0.8;0.2 0.2 0.4 0.8"
                                                repeatCount="indefinite" values="0;2;0;0" />
                                        </circle>
